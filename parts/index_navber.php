      ...
      <div class="side-bar">
        ...
        <div class="menu">
          ...
          <div class="item">
            ...
            <div class="sub-menu" >
            <?php if (!empty($_SESSION['admin'] )) : ?>
              <a href="2_goods_product_list.php" class="sub-item"style="<?= (empty($_SESSION['admin'])) && (empty($_SESSION['user1']))
            ? 'display:none': ''?>;">商品列表</a>
              <a href="2_goods_insert_form.php" class="sub-item"style="<?= (empty($_SESSION['admin'])) && (empty($_SESSION['user1']))
            ? 'display:none': ''?>;">新增商品</a>
              <?php endif; ?>
