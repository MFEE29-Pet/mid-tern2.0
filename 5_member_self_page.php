    ...
    <div class="col-lg-6">
      <div class="card-body">
        ...
        <form name="form1" onsubmit="checkForm(); return false;">
          <div class="mb-3">
            <label for="name" class="form-label">會員編號</label>
            <input type="text" class="form-control" id="name" name="name" value="<?=$r['sid']?>" disabled>
          </div>
          <div class="mb-3">
            <label for="name" class="form-label">大頭照</label><br>
            <img src="./store/<?=$r['member_photo']?> " alt="您未上傳大頭照">
          </div>
          <div class="mb-3">
